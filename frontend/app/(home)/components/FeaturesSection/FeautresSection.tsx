    ...
    <div className="py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          >
            <Balancer>Revolutionize Your Data Management</Balancer>
          </h1>
          ...
          >
            <Balancer>
              RAGMind reimagines data retrieval and management with leading-edge
              AI, offering a new era of precision and ease in data.
            </Balancer>
          </p>
        </div>
      </div>
      <div className="relative overflow-hidden pt-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <Image
            src="/assets/project-app-screenshot.png"
            alt="App screenshot"
