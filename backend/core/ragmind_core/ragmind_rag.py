...
from ragmind_core.config import RAGConfig
from ragmind_core.llm import LLMEndpoint
from ragmind_core.models import (
...
from ragmind_core.prompts import ANSWER_PROMPT, CONDENSE_QUESTION_PROMPT
from ragmind_core.utils import (
    combine_documents,
    format_file_list,
    get_chunk_metadata,
...
class RAGMindQARAG:
    ...
    def filter_history(
        ...
        Returns a filtered chat_history with in priority: first max_tokens, then max_history where a Human message and an AI message count as one pair a token is 4 characters
        """
        total_tokens = 0
        total_pairs = 0
    ...
    def answer(
        ...
        question: str,
        history: ChatHistory,
        list_files: list[RAGMindKnowledge],
