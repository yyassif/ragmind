...
from ragmind_api.middlewares.auth.auth_bearer import AuthBearer, get_current_user
from ragmind_api.models.brains_subscription_invitations import BrainSubscription
from ragmind_api.modules.brain.entity.brain_entity import RoleEnum
from ragmind_api.modules.brain.repository import IntegrationBrain
from ragmind_api.modules.brain.service.api_brain_definition_service import (
...
from ragmind_api.modules.brain.service.brain_subscription import (
    SubscriptionInvitationService,
    resend_invitation_email,
)
from ragmind_api.modules.brain.service.brain_user_service import BrainUserService
from ragmind_api.modules.prompt.entity.prompt import PromptStatusEnum
...
from ragmind_api.modules.user.service.user_service import UserService
from ragmind_api.routes.headers.get_origin_header import get_origin_header
    ...
    for user in users:
        ...
        try:
            ...
            if should_send_invitation_email:
                resend_invitation_email(
                    subscription,
                    inviter_email=current_user.email or "RAGMind",
