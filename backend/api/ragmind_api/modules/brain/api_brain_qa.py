...
from ragmind_api.modules.brain.service.call_brain_api import call_brain_api
from ragmind_api.modules.brain.service.get_api_brain_definition_as_json_schema import (
    ...
    async def make_completion(
        ...
        for chunk in response:
            ...
            if finish_reason == "stop":
                self.log_steps("RAGMind has finished", "info")
                break
            if (
                ...
                self.log_steps("RAGMind has called the API", "info")
                messages.append(
                    {
                        "role": "function",
