...
from ragmind_api.modules.brain.qa_interface import QAInterface
...
from ragmind_api.modules.chat.dto.chats import ChatQuestion
...
SYSTEM_MESSAGE = "Your name is RAGMind. You're a helpful assistant. If you don't know the answer, just say that you don't know, don't try to make up an answer.When answering use markdown or any other techniques to display the content in a nice and aerated way."
