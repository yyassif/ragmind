...
from ragmind_api.modules.brain.dto.inputs import (
    BrainQuestionRequest,
    BrainUpdatableProperties,
    CreateBrainProperties,
)
from ragmind_api.modules.brain.entity.brain_entity import PublicBrain, RoleEnum
from ragmind_api.modules.brain.entity.integration_brain import (
...
from ragmind_api.modules.brain.service.get_question_context_from_brain import (
    get_question_context_from_brain,
)
from ragmind_api.modules.brain.service.integration_brain_service import (
...
async def retrieve_public_brains() -> list[PublicBrain]:
    """Retrieve all RAGMind public brains."""
...
async def update_existing_brain_secrets(
    ...
    existing_brain = brain_service.get_brain_details(brain_id, None) # type: ignore
