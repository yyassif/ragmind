...
from ragmind_api.modules.brain.qa_interface import model_compatible_with_function_calling
...
system_message_template = (
    f"Your name is RAGMind. You're a helpful assistant. Today's date is {today_date}."
)
...
class RAGMindRAG(BaseModel):
    """
    RAGMind implementation of the RAGInterface.
    """
    ...
    def get_chain(self):
        ...
        # TODO Should be a class level attribute
        compressor = None
        # TODO fix
