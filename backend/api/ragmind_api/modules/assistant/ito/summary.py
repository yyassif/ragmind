...
from ragmind_api.modules.assistant.dto.outputs import (
    AssistantOutput,
    InputFile,
    Inputs,
    OutputBrain,
...
from ragmind_api.modules.assistant.ito.ito import ITO
...
def summary_inputs():
    S3_PATH = "https://ragmind.s3.eu-west-3.amazonaws.com"
    output = AssistantOutput(
        ...
        icon_url=f"{S3_PATH}/report_94bea8b918.png",
        inputs=Inputs(
            files=[
                InputFile(
