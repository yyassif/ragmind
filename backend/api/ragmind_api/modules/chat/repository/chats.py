...
from ragmind_api.modules.chat.dto.inputs import ChatMessageProperties, QuestionAndAnswer
from ragmind_api.modules.chat.entity.chat import Chat, ChatHistory
from ragmind_api.modules.dependencies import BaseRepository
...
class ChatRepository(BaseRepository):
    ...
    async def add_question_and_answer(
        ...
        try:
            ...
            await self.session.rollback()
            # TODO for now, build an exception system
