...
from ragmind_api.middlewares.auth.jwt_token_handler import (
    decode_access_token,
    verify_token,
)
from ragmind_api.modules.api_key.service.api_key_service import ApiKeyService
...
class AuthBearer(HTTPBearer):
    ...
    def get_test_user(self) -> UserIdentity:
        return UserIdentity(
            email="admin@yyassif.dev", id="39418e3b-0258-4452-af60-7acfcc1263ff"  # type: ignore
