...
create table "public"."user_settings" (
    "user_id" uuid not null,
    "models" jsonb default '["gpt-3.5-turbo-1106", "gpt-4-0125-preview"]'::jsonb,
...
insert into storage.buckets (id, name) values ('ragmind', 'ragmind');

CREATE POLICY "Access RAGMind Storage 1jccrwz_0" ON storage.objects FOR INSERT TO anon WITH CHECK (bucket_id = 'ragmind');

CREATE POLICY "Access RAGMind Storage 1jccrwz_1" ON storage.objects FOR SELECT TO anon USING (bucket_id = 'ragmind');

CREATE POLICY "Access RAGMind Storage 1jccrwz_2" ON storage.objects FOR UPDATE TO anon USING (bucket_id = 'ragmind');

CREATE POLICY "Access RAGMind Storage 1jccrwz_3" ON storage.objects FOR DELETE TO anon USING (bucket_id = 'ragmind');
