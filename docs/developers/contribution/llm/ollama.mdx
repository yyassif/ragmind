...
The guide was put together in collaboration with members of the RAGMind Discord, **Using RAGMind fully locally** thread. That is a good place to discuss it. https://discord.com/invite/HUpRgp2HG8
...
## Add Ollama Model to RAGMind

Now that you have your model running locally, you need to add it to RAGMind.

In order to allow the user to choose between the Ollama, we need to add a new model to the RAGMind backend.
