---
title: Llama Parse
description: Use Llama Parse to read complex document in RAGMind
---

# Llama Parse

Llama Parse is a tool from Llama Index that allows you to read complex documents in RAGMind.
...
4. Use the Llama Parse tool to read complex documents in RAGMind - Currently only supports `pdf`, `docx`, and `doc` files.
