---
title: New Models
description: Learn how to add new models to RAGMind.
---

# Add New Models

RAGMind allows you to add new models to your account. You can add models from the OpenAI API or from your own custom models.
...
<Steps>
  ...
  <Step title="Select the table models">
    Select the table `models`. ![Supabase tables](/images/supabase-table.png)
  </Step>
  <Step title="Add a new model">Click on the "Add new row" button.</Step>
  ...
  <Step title="Input the model's name">
    Input the model's name in the `models` array default value. ![Supabase user
    settings models](/images/supabase-user-settings-models.png)
  </Step>
