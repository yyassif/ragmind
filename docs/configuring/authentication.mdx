...
description: Learn how to configure authentication in RAGMind.
---

# Authentication Methods

RAGMind offers three authentication methods when self-hosting. You can choose which authentication methods you want to offer to your users from these three options:
