---
title: Emails
description: Allow RAGMind to send emails
---

# Emails with Resend

RAGMind uses the [Resend](https://resend.com/) service to send emails. Resend is a transactional email service that allows you to send emails from your application. This guide will show you how to set up Resend in RAGMind.

## Setting up Resend

To set up Resend in RAGMind, you need to configure the following environment variables in your `.env` file:
