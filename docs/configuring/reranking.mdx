---
title: Reranking
description: Learn how to configure reranking in RAGMind.
---

RAGMind uses its own reranking service to improve the quality of search results. This guide will show you how to configure the reranking service in RAGMind.
